...
class _ChaoReturnState extends State<ChaoReturn> {
  ...
  int? selectbot = 0, bot = 0, botc = 0, _Pakan = 0, renTal_lavel = 0;
  double sum_Pakan = 0,
      sum_Pakan_KF = 0,
      sum_conx = 0,
      sum_ST = 0,
    ...
    try {
      ...
      if (result.toString() != 'true') {
        for (var map in result) {
          ...
          var sum_P = double.parse(contractxPakanModel.total!);
          setState(() {
                          ...
                          child: Column(
                            children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: AutoSizeText(
                                        ...
                                        maxFontSize: 25,
                                        maxLines: 1,
                                        '${contractxPakanModels[i].expname}',
                                        textAlign: TextAlign.start,
                                        style: TextStyle(
                                            color: PeopleChaoScreen_Color
                                                .Colors_Text2_,
                                    ...
                                    Expanded(
                                      child: AutoSizeText(
                                        ...
                                        maxFontSize: 25,
                                        maxLines: 1,
                                        '${nFormat.format(double.parse(contractxPakanModels[i].total!))}',
                                        textAlign: TextAlign.end,
                                        style: TextStyle(
                                            color: PeopleChaoScreen_Color
                                                .Colors_Text2_,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: AutoSizeText(
                                      ...
                                      maxFontSize: 25,
                                      maxLines: 1,
                                      '${nFormat.format(double.parse(contractxPakanModels.map((e) => double.parse(e.total!)).reduce((a, b) => a + b).toStringAsFixed(2)))}',
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                          color: Colors.grey.shade600,
                                          fontFamily: FontWeight_.Fonts_T),
                              ...
                              nFormat.format(sum_conx) ==
                                      nFormat.format(sum_Pakan + sum_Pakan_KF)
                                  ? SizedBox()
                                  : Row(
                                      children: [
                                        Expanded(
                                        ...
                                        Expanded(
                                          child: AutoSizeText(
                                            ...
                                            maxFontSize: 25,
                                            maxLines: 1,
                                            '${nFormat.format(sum_conx - sum_Pakan)}',
                                            textAlign: TextAlign.end,
                                            style: TextStyle(
                                                color: PeopleChaoScreen_Color
                                                    .Colors_Text2_,
