...
class Man_BillingNoteInvlice_PDF {
  static void ManBillingNoteInvlice_PDF(
    ...
    String? Form_aser;
    String? Form_qty;
    String? payment_Ptser1, payment_Ptname1, payment_Bno1, bank1, img1, btype1;
    String? payment_Ptser2, payment_Ptname2, payment_Bno2, bank2, img2, btype2;
    ...
    final tableData003 = [
      for (int index = 0; index < _InvoiceHistoryModels.length; index++)
        [
          ...
          ///---2
          '${nFormat.format((_InvoiceHistoryModels[index].nvat == null) ? 0.00 : double.parse(_InvoiceHistoryModels[index].nvat!))}',
