            ...
            pw.Container(
                ...
                child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        ' ' * 12 +
                            'บัดนี้ ใกล้ครบกำหนดระยะเวลาตามสัญญาบริการดังกล่าวแล้ว คู่สัญญาทั้งสองฝ่ายพิจารณาแล้วตกลงต่ออายุสัญญา',
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: font_Size,
                          font: ttf,
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0)
                                  ...
                                  : '(~${convertToThaiBaht(quotxSelectModels.where((e) => e.expser.toString() == '2').map((e) => e.pvat != null ? double.parse(e.pvat.toString()) : 0.00).fold(0.00, (a, b) => a + b))}~)',
                              textAlign: pw.TextAlign.left,
                              style: pw.TextStyle(
                                color: Colors_pd,
                                fontSize: font_Size,
                        ...
                        pw.Expanded(
                          ...
                          child: pw.Container(
                            ...
                            child: pw.Text(
                              (quotxSelectModels.length == 0)
                                  ? '(~${convertToThaiBaht(0.00)}~)'
                                  : '(~${convertToThaiBaht(quotxSelectModels.where((e) => e.expser.toString() == '2').map((e) => e.vat != null ? double.parse(e.vat.toString()) : 0.00).fold(0.00, (a, b) => a + b))}~)',
                              textAlign: pw.TextAlign.left,
                              style: pw.TextStyle(
                                color: Colors_pd,
                                fontSize: font_Size,
                      ...
                      pw.Text(
                        ' ' * 12 +
                            '5.	ผู้รับบริการจะต้องดำเนินกิจการที่ถูกต้องตามกฎหมาย อีกทั้งสินค้าและบริการที่นำมาประกอบกิจการ จะต้องไม่',
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: font_Size,
                          font: ttf,
                      ...
                      pw.Text(
                        ' ' * 15 +
                            'เป็นการละเมิดลิขสิทธิ์ สิทธิบัตร เครื่องหมายการค้า ตามกฎหมายว่าด้วยทรัพย์สินทางปัญญา หรือกฎหมายอื่นใดก็',
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: font_Size,
                          font: ttf,
                      ...
                      pw.Text(
                        ' ' * 15 + 'สัญญาบริการและเรียกค่าเสียหายได้ทันที',
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: font_Size,
                          font: ttf,
