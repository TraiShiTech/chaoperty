...
class Pdfgen_his_statusbill_TP6 {
//////////---------------------------------------------------->(ใบเสร็จรับเงิน/ใบกำกับภาษี)   ใช้  //

  static void exportPDF_statusbill_TP6(
      foder,
      tableData00,
      tableData01,
      context,
                                        ...
                                        child: pw.Container(
                                          ...
                                          child: pw.Column(
                                            children: [
                                              ...
                                              pw.Text(
                                                'บัญชี : ${finnancetransModels.where((model) => model.ptser == '6' && model.dtype != 'MM').map((model) => model.bno).join(', ')}',
                                                style: pw.TextStyle(
                                                  font: ttf,
                                                  fontSize: font_Size,
                                                  fontWeight:
                                                    ...
                                                    child: (finnancetransModels[i]
                                                        ...
                                                        ? pw.BarcodeWidget(
                                                            data: generateQRCode(
                                                                ...
                                                                amount: double.parse((finnancetransModels[i].total ==
                                                                            null ||
                                                                        finnancetransModels[i].total.toString() ==
                                                                            '')
                                                                    ? '0'
