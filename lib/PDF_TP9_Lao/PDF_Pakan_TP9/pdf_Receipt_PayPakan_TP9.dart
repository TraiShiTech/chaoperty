...
class PdfgenReceipt_PayPakan_TP9_Lao {
  //////////---------------------------------------------------->(ใบเสร็จรับเงินคืนเงินประกัน )
  static void exportPDF_Receipt_PayPakan_TP9_Lao(
      foder,
      tableData00,
      tableData01,
      context,
                                            ...
                                            pw.Text(
                                              (TitleType_Default_Receipt_Name !=
                                                  ...
                                                  ? (TitleType_Default_Receipt_Name
                                                              .toString() ==
                                                          'ต้นฉบับ')
                                                      ? 'ໃບຮັບເງິນຄືນການຮັບປະກັນ [ ຕົ້ນສະບັບ ]'
                                                      : 'ໃບຮັບເງິນຄືນການຮັບປະກັນ [ ສຳເນົາ ]'
                                                  : 'ໃບຮັບເງິນຄືນການຮັບປະກັນ',
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PreviewPdfgen_Billsplay(
              doc: pdf, title: 'ใบเสร็จคืนเงินประกัน-ໃບຮັບເງິນຄືນການຮັບປະກັນ'),
        ));
  }
