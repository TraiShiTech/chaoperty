...
class Pdfgen_his_statusbill_TP9_Lao {
//////////---------------------------------------------------->(ใบเสร็จรับเงิน/ใบกำกับภาษี)   ใช้  //

  static void exportPDF_statusbill_TP9_Lao(
      Cust_no,
      cid_s,
      Zone_s,
      Ln_s,
                                    ...
                                    children: [
                                      pw.Text(
                                        (cname.toString() == '' ||
                                                cname == null ||
                                                cname.toString() == 'null')
                                            ? 'ຊື່ /Name : ${(sname.toString() == '' || sname == null || sname.toString() == 'null') ? '-' : sname}'
                                            : 'ຊື່ /Name : ${(sname.toString() == '' || sname == null || sname.toString() == 'null') ? '-' : sname} (${(cname.toString() == '' || cname == null || cname.toString() == 'null') ? '-' : cname})',
                                        // (sname.toString() == null ||
                                        //         sname.toString() == '' ||
                                        //         sname.toString() == 'null')
                                        //     ? 'นามลูกค้า /Name : -'
                                      ...
                                      (ref_invoice.length > 1)
                                          ? pw.Text(
                                              'ອ້າງອີງ No./Refer no. : ${ref_invoice.toSet().map((model) => model).join(', ')}',
                                              textAlign: pw.TextAlign.left,
                                              style: pw.TextStyle(
                                                fontSize: font_Size,
                                                font: ttf,
                                              ...
                                              (TitleType_Default_Receipt_Name !=
                                                  ...
                                                  ? (numdoctax.toString() == '')
                                                      ...
                                                      : (TitleType_Default_Receipt_Name
                                                                  .toString() ==
                                                              'ต้นฉบับ')
                                                          ? 'ໃບຮັບເງິນ/ໃບເກັບພາສີ [ ຕົ້ນສະບັບ ]'
                                                          : 'ໃບຮັບເງິນ/ໃບເກັບພາສີ [ ສຳເນົາ ]'
                                                              'ໃບຮັບເງິນ/ໃບເກັບພາສີ'
                                                  : (numdoctax.toString() == '')
                                                      ? 'ໃບຮັບເງິນ'
                                                      : 'ໃບຮັບເງິນ/ໃບເກັບພາສີ',
                                    ...
                                    children: [
                                      ...
                                      pw.Text(
                                        (dayfinpay.toString() == '' ||
                                                ...
                                                dayfinpay == null)
                                            ? '-'
                                            : '${DateFormat('dd/MM').format(DateTime.parse(dayfinpay!))}/${DateTime.parse('${dayfinpay}').year + 0}',
                                        textAlign: pw.TextAlign.center,
                                        style: pw.TextStyle(
                                          fontSize: font_Size,
                                          font: ttf,
                            ...
                            child: pw.Align(
                              ...
                              child: pw.Text(
                                (tableData00[index][14].toString() != '0' &&
                                    ...
                                    ? 'ອັດຕາພິເສດ'
                                    : (tableData00[index][7].toString() == '0')
                                        ? '${tableData00[index][5]}'
                                        : '${tableData00[index][7]}',
                                maxLines: 2,
                                textAlign: pw.TextAlign.right,
                    ...
                    children: [
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Text(
                          ...
                          // '(~${convertToLaoBaht(double.parse(Total.toString()) + double.parse(sum_fee.toString()))}~)',
                          style: pw.TextStyle(
                            fontSize: font_Size,
                            fontWeight: pw.FontWeight.bold,
                            font: ttf,
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Column(
                              ...
                              children: [
                                ...
                                pw.Text(
                                  (hasNonCashTransaction)
                                      ? '      ບັນຊີ ${finnancetransModels.where((model) => model.dtype == 'KP' && model.ptser != null && model.ptser != '1').map((model) => model.bank).join(', ')} ເລກບັນຊີ ${finnancetransModels.where((model) => model.dtype == 'KP' && model.ptser != null && model.ptser != '1').map((model) => model.bno).join(', ')} [ ${finnancetransModels.where((model) => model.dtype == 'KP' && model.ptser != null && model.ptser != '1').map((model) => (model.ptname.toString() == 'Online Payment' ? 'PromptPay QR' : model.ptname == 'เงินโอน' ? 'ເລກບັນຊີ' : model.ptname == 'Beam Checkout' ? 'Beam Checkout' : 'Online Standard QR')).join(', ')} ]'
                                      : '      ບັນຊີ...................................ເລກບັນຊີ...................................',
                                  textAlign: pw.TextAlign.left,
                                  style: pw.TextStyle(
                                    fontSize: font_Size,
                                    ...
                                    pw.Expanded(
                                      ...
                                      child: pw.Text(
                                        (hasNonCashTransaction ||
                                                hasNonCashTransaction1)
                                            ? '(   ) 3. ອື່ນໆ.............................'
                                            : '( / ) 3. ອື່ນໆ ${finnancetransModels.where((model) => model.ptser != '6' || model.ptser != '5' || model.ptser != '2' || model.ptser != '1' && model.dtype == 'KP').map((model) => model.bank).join(', ')}',
                                        textAlign: pw.TextAlign.left,
                                        style: pw.TextStyle(
                                          fontSize: font_Size,
                                          font: ttf,
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PreviewPdfgen_Billsplay(
              doc: pdf,
              title: (numdoctax.toString() == '')
                  ? 'ใบเสร็จรับเงิน-ໃບຮັບເງິນ $numinvoice'
                  : 'ใบเสร็จรับเงิน/ใบกำกับภาษี-ໃບຮັບເງິນ/ໃບເກັບພາສີ $numdoctax'),
        ));
  }
}
