...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('B4').setText('รหัสสมาชิก');
    sheet.getRangeByName('C4').setText('ชื่อร้าน');
    sheet.getRangeByName('D4').setText('ชื่อผู้เช่า/บริษัท');
    sheet.getRangeByName('E4').setText('เบอร์โทร');
    sheet.getRangeByName('F4').setText('อีเมล');
    sheet.getRangeByName('G4').setText('Tax');
    sheet.getRangeByName('H4').setText('ประเภท');
    sheet.getRangeByName('I4').setText('ที่อยู่');
    ...
    int indextotol = 0;
    for (var index = 0; index < customerModels.length; index++) {
      ...
      sheet.getRangeByName('C${index + 5}').setText(
            (customerModels[index].scname == null ||
