...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('K2').setText('ณ วันที่: ${Value_selectDate} ');
    ...
    for (var i1 = 0; i1 < _TransReBillModels.length; i1++) {
      ...
      for (var i2 = 0; i2 < TransReBillModels[i1].length; i2++) {
        ...
        //     double.parse('${TransReBillModels[i1][i2].ramt}'));
        // sheet.getRangeByName('J${indextotol + 5 - 1}').setNumber(
        //     double.parse('${TransReBillModels[i1][i2].ramtd}'));
        ...
        sheet.getRangeByName('N${indextotol + 5 - 1}').setNumber((ser_dis == 0)
            ...
            //(double.parse('${_TransReBillModels[i1].total_bill}') -
            //             double.parse(
            //                 '${_TransReBillModels[i1].total_dis}'))
            // /
            //         TransReBillModels[i1].length
            );

        // sheet.getRangeByName('O${indextotol + 5 - 1}').setNumber(
        //     double.parse('${TransReBillModels[i1][i2].total}'));
