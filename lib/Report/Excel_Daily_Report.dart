...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('M2').setText('ณ วันที่: ${Value_selectDate}');
    ...
    for (var i1 = 0; i1 < _TransReBillModels.length; i1++) {
      for (var i2 = 0; i2 < TransReBillModels[i1].length; i2++) {
        ...
        sheet.getRangeByName('M${indextotol + 4 - 1}').rowHeight = 30;
        sheet.getRangeByName('N${indextotol + 4 - 1}').rowHeight = 30;
        // sheet.getRangeByName('O${indextotol + 4 - 1}').rowHeight = 30;
        // sheet.getRangeByName('P${indextotol + 4 - 1}').rowHeight = 30;
        ...
        sheet
            ...
            .setText('${TransReBillModels[i1][i2].type}');
        ...
        sheet.getRangeByName('H${indextotol + 5 - 1}').setText(
            (TransReBillModels[i1][i2].sname == null)
                ? '${TransReBillModels[i1][i2].remark}'
                : '${TransReBillModels[i1][i2].sname}');

        sheet
            .getRangeByName('I${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].nvat}'));

        sheet
            .getRangeByName('J${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].vat}'));
        sheet
            .getRangeByName('K${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].ramt}'));
        sheet
            .getRangeByName('L${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].ramtd}'));
        sheet
            .getRangeByName('M${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].amt}'));
        sheet
            .getRangeByName('N${indextotol + 5 - 1}')
            .setNumber(double.parse('${TransReBillModels[i1][i2].total}'));
      }
      print('-------------------------');
    }
