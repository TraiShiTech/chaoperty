...
class Mini_Ex_BankmovemenReport {
  static void mini_exportExcel_BankmovemenReport(
      ser_type_repro,
      context,
      NameFile_,
    ...
    for (var index1 = 0; index1 < TransReBillBank.length; index1++) {
      ...
      sheet.getRangeByName('U${indextotol + 5 - 1}').setText(
            (TransReBillBank[index1].sdate == null ||
                    TransReBillBank[index1].sdate.toString() == '')
                ? ''
