...
///////////--------------------------------------------->()
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    String url = (Value_Report ==
        ...
        ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search'
        : '${MyConstant().domain}/GC_bill_pay_historyselectAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$serzone_s&datex=$Value_TransDate_Daily&Typesearch=$Type_search';
    try {
      var response = await http.get(Uri.parse(url));
