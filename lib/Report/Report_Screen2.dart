...
///////------------------------------------------------------------------>
  Future<Null> read_GC_zone() async {
    ...
    try {
      ...
      print('Error-Dis(read_GC_zone) : ${e}');
    }
  }
...
///////////--------------------------------------------->(รายงานรายรับ(เฉพาะรายการที่มีส่วนลด))
  Future<Null> red_Trans_billIncome() async {
    ...
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeDisReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_IncomeDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_DailyDisReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_DailyDisReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
    ...
    try {
      ...
      print('Error-Dis(red_Trans_billIncome) : ${e}');
    }
  }
...
///////////--------------------------------------------->(รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่มีส่วนลด))
  Future<Null> red_Trans_billMovemen() async {
    ...
    ///-------->
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenDisReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyDisReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyDisReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
    ...
    try {
      ...
      print('Error-Dis(red_Trans_billMovemen) : ${e}');
    }
  }
...
///////////--------------------------------------------->()
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    String url = (Value_Report ==
        ...
        ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&datex=$Value_TransDate_Daily&Typesearch=$Type_search'
        : '${MyConstant().domain}/GC_bill_pay_historyselectAllDisReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&datex=$Value_TransDate_Daily&Typesearch=$Type_search';
    try {
      var response = await http.get(Uri.parse(url));
                      ...
                      children: [
                        ...
                        (Type_search != 'Daily')
                            ? const Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                  'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด)',
                                  style: TextStyle(
                                    color: ReportScreen_Color.Colors_Text2_,
                                    // fontWeight: FontWeight.bold,
                                    fontFamily: Font_.Fonts_T,
                            ...
                            : (TransReBillModels.isEmpty)
                                ? Padding(
                                    ...
                                    child: Text(
                                      (TransReBillModels.isEmpty &&
                                          ...
                                          ? 'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด) (ไม่พบข้อมูล ✖️)'
                                          : 'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด)',
                                      style: const TextStyle(
                                        color: ReportScreen_Color.Colors_Text2_,
                                        // fontWeight: FontWeight.bold,
                                ...
                                : (TransReBillModels.length != 0 &&
                                    ...
                                    ? SizedBox(
                                        ...
                                        children: [
                                          ...
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                            child: Text(
                                              'กำลังโหลดรายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด) ...',
                                              style: TextStyle(
                                                color: ReportScreen_Color
                                                    .Colors_Text2_,
                                                // fontWeight: FontWeight.bold,
                                    ...
                                    : const Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด) ✔️',
                                          style: TextStyle(
                                            color: ReportScreen_Color
                                                .Colors_Text2_,
                                            // fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Center(
                      ...
                      (Type_search.toString() == 'Mon')
                          ...
                          : (zone_name_Trans_Daily == null)
                              ? 'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด)  (กรุณาเลือกโซน)'
                              : 'รายงานรายรับประจำวัน(เฉพาะรายการที่มีส่วนลด) (โซน : $zone_name_Trans_Daily)',
                      style: const TextStyle(
                        color: ReportScreen_Color.Colors_Text1_,
                        fontWeight: FontWeight.bold,
                        fontFamily: FontWeight_.Fonts_T,
                    ...
                    Center(
                      ...
                      (Type_search.toString() == 'Mon')
                          ? (zone_name_Trans_Mon == null)
                              ...
                              : 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่มีส่วนลด)  (โซน : $zone_name_Trans_Mon)'
                          : (zone_name_Trans_Daily == null)
  ...
  void InkWell_onTap(context) async {
    ...
    if (_verticalGroupValue_NameFile == 'กำหนดเอง') {
      ...
      if (_verticalGroupValue_PassW == 'PDF') {
        ...
        if (Value_Report == 'รายงานรายรับ(เฉพาะรายการที่มีส่วนลด)') {
