...
///////////--------------------------------------------->(รายงานรายรับ(เฉพาะล็อคเสียบ))
  Future<Null> red_Trans_billIncome() async {
    ...
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeLockpayReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_IncomeLockpayReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_DailyLockpayReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_DailyLockpayReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
...
///////////--------------------------------------------->(รายงานการเคลื่อนไหวธนาคาร(เฉพาะล็อคเสียบ))
  Future<Null> red_Trans_billMovemen() async {
    ...
    ///-------->
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenLockpayReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenLockpayReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyLockpayReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyLockpayReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
...
///////////--------------------------------------------->()
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    String url = (Value_Report == 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะล็อคเสียบ)' ||
        ...
        ? '${MyConstant().domain}/GC_bill_pay_historyselectBankAllLockReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&datex=$Value_TransDate_Daily&Typesearch=$Type_search'
        : '${MyConstant().domain}/GC_bill_pay_historyselectAllLockReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon&datex=$Value_TransDate_Daily&Typesearch=$Type_search';
    try {
      var response = await http.get(Uri.parse(url));
