...
///////------------------------------------------------------------------>
  Future<Null> read_GC_zone() async {
    ...
    try {
      ...
      print('Error-Tax(read_GC_zone) : ${e}');
    }
  }
  ...
  Future<Null> read_GC_rental() async {
    ...
    try {
      ...
      print('Error-Tax(read_GC_rental) : ${e}');
    }
  }
...
///////////--------------------------------------------->(รายงานรายรับ(-Tax))
  Future<Null> red_Trans_billIncome() async {
    ...
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_IncomeTaxReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_IncomeTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_DailyTaxReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_DailyTaxReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
    ...
    try {
      ...
      print('Error-Tax(red_Trans_billIncome) : ${e}');
    }
  }

///////////--------------------------------------------->(รายงานการเคลื่อนไหวธนาคาร(-Tax))
  Future<Null> red_Trans_billMovemen() async {
    ...
    ///-------->
    String url_Mon = (zone_ser_Trans_Mon.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenTaxReport_All.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon'
        : '${MyConstant().domain}/GC_bill_pay_BC_BankmovemenTaxReport.php?isAdd=true&ren=$ren&mont_h=$Mon_Trans_Mon&yea_r=$YE_Trans_Mon&serzone=$zone_ser_Trans_Mon';

    String url_Daily = (zone_ser_Trans_Daily.toString() == '0')
        ? '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyTaxReport_All.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily'
        : '${MyConstant().domain}/GC_bill_pay_BC_Bank_DailyTaxReport.php?isAdd=true&ren=$ren&date=$Value_TransDate_Daily&serzone=$zone_ser_Trans_Daily';
    ...
    try {
      ...
      print('Error-Tax(red_Trans_billMovemen) : ${e}');
    }
  }
...
///////////--------------------------------------------->()
  Future<Null> red_Trans_selectIncome(ciddoc, docnoin, index) async {
    ...
    try {
      ...
      print('Error-Tax(red_Trans_selectIncome) : ${e}');
    }
  }
  ...
  Future<Null> red_Trans_selectIncomeAll() async {
    ...
    try {
      ...
      print(' Error-Tax(red_Trans_selectIncomeAll) : ${e}');
    }
  }
                      ...
                      children: [
                        ...
                        (Type_search != 'Mon')
                            ? const Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                  'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                  style: TextStyle(
                                    color: ReportScreen_Color.Colors_Text2_,
                                    // fontWeight: FontWeight.bold,
                                    fontFamily: Font_.Fonts_T,
                            ...
                            : (TransReBillModels.isEmpty)
                                ? Padding(
                                    ...
                                    child: Text(
                                      (TransReBillModels.isEmpty &&
                                          ...
                                          ? 'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี) (ไม่พบข้อมูล ✖️)'
                                          : 'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                      style: const TextStyle(
                                        color: ReportScreen_Color.Colors_Text2_,
                                        // fontWeight: FontWeight.bold,
                                ...
                                : (TransReBillModels.length != 0 &&
                                    ...
                                    ? SizedBox(
                                        ...
                                        children: [
                                          ...
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                            child: Text(
                                              'กำลังโหลดรายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี) ...',
                                              style: TextStyle(
                                    ...
                                    : const Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี) ✔️',
                                          style: TextStyle(
                                            color: ReportScreen_Color
                                                .Colors_Text2_,
                                            // fontWeight: FontWeight.bold,
                            ...
                            : (TransReBillBank.isEmpty)
                                ? Padding(
                                    ...
                                    child: Text(
                                      (TransReBillBank.isEmpty &&
                                              ...
                                              YE_Trans_Mon != null &&
                                              zone_name_Trans_Mon != null)
                                          ? 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี) (ไม่พบข้อมูล ✖️)'
                                          : 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                      style: const TextStyle(
                                        color: ReportScreen_Color.Colors_Text2_,
                                        // fontWeight: FontWeight.bold,
                                ...
                                : (TransReBillBank.length != 0 &&
                                    ...
                                    ? SizedBox(
                                        ...
                                        children: [
                                          ...
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                            child: Text(
                                              'กำลังโหลดรายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี) ...',
                                              style: TextStyle(
                                                color: ReportScreen_Color
                                                    .Colors_Text2_,
                                                // fontWeight: FontWeight.bold,
                                    ...
                                    : const Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี) ✔️',
                                          style: TextStyle(
                                            color: ReportScreen_Color
                                                .Colors_Text2_,
                                            // fontWeight: FontWeight.bold,
                      ...
                      children: [
                        ...
                        (Type_search != 'Daily')
                            ? const Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                  'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                  style: TextStyle(
                                    color: ReportScreen_Color.Colors_Text2_,
                                    // fontWeight: FontWeight.bold,
                                    fontFamily: Font_.Fonts_T,
                            ...
                            : (TransReBillModels.isEmpty)
                                ? Padding(
                                    ...
                                    child: Text(
                                      (TransReBillModels.isEmpty &&
                                          ...
                                          ? 'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) (ไม่พบข้อมูล ✖️)'
                                          : 'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                      style: const TextStyle(
                                        color: ReportScreen_Color.Colors_Text2_,
                                        // fontWeight: FontWeight.bold,
                                ...
                                : (TransReBillModels.length != 0 &&
                                    ...
                                    ? SizedBox(
                                        ...
                                        children: [
                                          ...
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                            child: Text(
                                              'กำลังโหลดรายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) ...',
                                              style: TextStyle(
                                                color: ReportScreen_Color
                                                    .Colors_Text2_,
                                                // fontWeight: FontWeight.bold,
                                    ...
                                    : const Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) ✔️',
                                          style: TextStyle(
                                            color: ReportScreen_Color
                                                .Colors_Text2_,
                                            // fontWeight: FontWeight.bold,
                            ...
                            : (TransReBillBank.isEmpty)
                                ? Padding(
                                    ...
                                    child: Text(
                                      (TransReBillBank.isEmpty &&
                                              Value_TransDate_Daily != null &&
                                              zone_name_Trans_Daily != null)
                                          ? 'รายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) (ไม่พบข้อมูล ✖️)'
                                          : 'รายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)',
                                      style: const TextStyle(
                                        color: ReportScreen_Color.Colors_Text2_,
                                        // fontWeight: FontWeight.bold,
                                ...
                                : (TransReBillBank.length != 0 &&
                                    ...
                                    ? SizedBox(
                                        ...
                                        children: [
                                          ...
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                            child: Text(
                                              'กำลังโหลดรายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) ...',
                                              style: TextStyle(
                                                color: ReportScreen_Color
                                                    .Colors_Text2_,
                                                // fontWeight: FontWeight.bold,
                                    ...
                                    : const Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          'รายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) ✔️',
                                          style: TextStyle(
                                            color: ReportScreen_Color
                                                .Colors_Text2_,
                                            // fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Center(
                      ...
                      (Type_search.toString() == 'Mon')
                          ? (zone_name_Trans_Mon == null)
                              ? 'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)  (กรุณาเลือกโซน)'
                              : 'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)  (โซน : $zone_name_Trans_Mon)'
                          : (zone_name_Trans_Daily == null)
                              ? 'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)  (กรุณาเลือกโซน)'
                              : 'รายงานรายรับประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) (โซน : $zone_name_Trans_Daily)',
                      style: const TextStyle(
                        color: ReportScreen_Color.Colors_Text1_,
                        fontWeight: FontWeight.bold,
                        fontFamily: FontWeight_.Fonts_T,
                ...
                return Column(
                  children: [
                    Center(
                      ...
                      (Type_search.toString() == 'Mon')
                          ? (zone_name_Trans_Mon == null)
                              ? 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี)  (กรุณาเลือกโซน)'
                              : 'รายงานการเคลื่อนไหวธนาคาร(เฉพาะรายการที่ออกใบกำกับภาษี)  (โซน : $zone_name_Trans_Mon)'
                          : (zone_name_Trans_Daily == null)
                              ? 'รายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี)  (กรุณาเลือกโซน)'
                              : 'รายงานการเคลื่อนไหวธนาคารประจำวัน(เฉพาะรายการที่ออกใบกำกับภาษี) (โซน : $zone_name_Trans_Daily)',
                      style: const TextStyle(
                        color: ReportScreen_Color.Colors_Text1_,
                        fontWeight: FontWeight.bold,
                        fontFamily: FontWeight_.Fonts_T,
  ...
  void InkWell_onTap(context) async {
    ...
    if (_verticalGroupValue_NameFile == 'กำหนดเอง') {
      ...
      if (_verticalGroupValue_PassW == 'PDF') {
        ...
        if (Value_Report == 'รายงานรายรับ(เฉพาะรายการที่ออกใบกำกับภาษี)') {
