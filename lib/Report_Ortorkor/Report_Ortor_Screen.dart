...
import 'Report_Ortor_ScreenA.dart';
import 'Report_Ortor_ScreenB.dart';

class Report_Ortor_Screen extends StatefulWidget {
  const Report_Ortor_Screen({super.key});

  @override
  State<Report_Ortor_Screen> createState() => _Report_Ortor_ScreenState();
}

class _Report_Ortor_ScreenState extends State<Report_Ortor_Screen> {
  int ser_pang = -1;
