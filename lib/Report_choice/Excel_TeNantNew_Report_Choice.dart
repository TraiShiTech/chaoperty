...
////////////-------------------------------------------------------->
    ...
    sheet.getRangeByName('A1').setText(
          (Value_Chang_Zone_People_Renew == null)
              ? 'รายงานผู้เช่ารายใหม่ ประจำเดือน ${Mon_PeopleRenew_Mon} ${YE_PeopleRenew_Mon} (กรุณาเลือกโซน)'
              : 'รายงานผู้เช่ารายใหม่ ประจำเดือน ${Mon_PeopleRenew_Mon} ${YE_PeopleRenew_Mon} (โซน : $Value_Chang_Zone_People_Renew)',
          // (Value_Chang_Zone_People_Renew == null)
...
// Protecting the Worksheet by using a Password
    ...
    sheet.getRangeByName('X2').columnWidth = 25;
    sheet.getRangeByName('Y2').columnWidth = 25;

    sheet.getRangeByName('A2').setText('ลำดับที่');
    sheet.getRangeByName('B2').setText('เลขที่สัญญา');
    sheet.getRangeByName('C2').setText('เลขบัญชีVAN');
    ...
    sheet.getRangeByName('J2').setText('ระยะเวลา');
    sheet.getRangeByName('K2').setText('ประเภทสินค้า');
    sheet.getRangeByName('L2').setText('น้ำ + ไฟ');

    sheet.getRangeByName('M2').setText('ค่าเช่า');
    sheet.getRangeByName('N2').setText('VAT7% ค่าเช่า');
    sheet.getRangeByName('O2').setText('ค่าเช่ารวมVAT');

    sheet.getRangeByName('P2').setText('ค่าบริการ');
    sheet.getRangeByName('Q2').setText('VAT7%  ค่าบริการ');
    sheet.getRangeByName('R2').setText('ค่าบริการรวมVAT');

    sheet.getRangeByName('S2').setText('เงินประกัน');

    sheet.getRangeByName('T2').setText('เงินประกันรวมVAT');

    sheet.getRangeByName('U2').setText('ค่าอุปกรณ์รวมvat');
    sheet.getRangeByName('V2').setText('รวมทั้งสิ้น');
    sheet.getRangeByName('W2').setText('วันที่ใบเสร็จเงินประกัน');

    sheet.getRangeByName('X2').setText('เลขที่ใบเสร็จเงินประกัน');
    sheet.getRangeByName('Y2').setText('ผู้ดูแล');
    ...
    for (int index = 0; index < teNantModels_Renew.length; index++) {
      ...
      sheet.getRangeByName('N${index + 3}').setNumber(0.00);

      sheet.getRangeByName('O${index + 3}').setNumber(0.00);
      sheet.getRangeByName('P${index + 3}').setNumber(0.00);

      //---
      sheet.getRangeByName('Q${index + 3}').setNumber(0.00);

      sheet.getRangeByName('R${index + 3}').setNumber(0.00);
      sheet.getRangeByName('S${index + 3}').setNumber(0.00);

      sheet.getRangeByName('T${index + 3}').setNumber(0.00);
      sheet.getRangeByName('U${index + 3}').setText('');

      sheet.getRangeByName('V${index + 3}').setText('');

      sheet.getRangeByName('W${index + 3}').setText('');
      sheet.getRangeByName('X${index + 3}').setText('');
      sheet.getRangeByName('Y${index + 3}').setText('');
