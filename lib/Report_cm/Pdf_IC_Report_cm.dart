...
class Pdfgen_IncomeReport_cm {
/////////////////////////////////////-------------------->(รายงานรายรับ)
  static void displayPdf_IncomeReport_cm(
      context,
      renTal_name,
      Value_Report,
      Pre_and_Dow,
    ...
    for (int indexsum1 = 0;
        ...
        indexsum1++) {
      Sum_Ramt_ =
          Sum_Ramt_ + double.parse(_TransReBillModels_Income[indexsum1].ramt!);

      Sum_Ramtd_ = Sum_Ramtd_ +
          double.parse(_TransReBillModels_Income[indexsum1].ramtd!);

      Sum_Amt_ =
          Sum_Amt_ + double.parse(_TransReBillModels_Income[indexsum1].amt!);

      Sum_Total_ = Sum_Total_ +
          double.parse(_TransReBillModels_Income[indexsum1].total!);
      // for (int indexsum2 = 0;
      //     indexsum2 <
          ...
          return [
            pw.Column(
              ...
              children: [
                ...
                for (int index1 = 0;
                    index1 < _TransReBillModels_Income.length;
                    index1++)
                  pw.Padding(
                                ...
                                children: [
                                  ...
                                  pw.Expanded(
                                    ...
                                    child: pw.Container(
                                      ...
                                      child: pw.Center(
                                        child: pw.Text(
                                          '${TransReBillModels_Income[index1][index2].type}',
                                          maxLines: 2,
                                          style: pw.TextStyle(
                                              fontSize: 10.0,
                                              font: ttf,
                                  ...
                                  pw.Expanded(
                                    ...
                                    child: pw.Container(
                                      ...
                                      child: pw.Center(
                                        child: pw.Text(
                                          (TransReBillModels_Income[index1]
                                                          [index2]
                                                      .ramt
                                                      .toString() ==
                                                  'null')
    ...
    if (Pre_and_Dow == 'Download') {
      ...
      if (_verticalGroupValue_NameFile.toString() == 'จากระบบ') {
        final dir = await FileSaver.instance
            .saveFile("${Value_Report}", data, "pdf", mimeType: type);
      } else {
        final dir = await FileSaver.instance
