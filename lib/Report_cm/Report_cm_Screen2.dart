...
class Report_cm_Screen2 extends StatefulWidget {
  const Report_cm_Screen2({super.key});

  @override
  State<Report_cm_Screen2> createState() => _Report_cm_Screen2State();
}

class _Report_cm_Screen2State extends State<Report_cm_Screen2> {
...
///////////////////////////---------------------------------->
  ...
  Future<Null> red_Trans_bill_Groptype_daly() async {
    ...
    String url =
        '${MyConstant().domain}/GC_bill_pay_BC_DailyReport_CMma_type.php?isAdd=true&ren=$ren&date=$Value_selectDate_Daily_Type_';
    try {
      var response = await http.get(Uri.parse(url));
  ...
  Future<Null> red_Trans_bill_Groptype_daly_Sub_zone() async {
    ...
    String url =
        '${MyConstant().domain}/GC_bill_pay_BC_DailyReport_CMma_type_Sub_zone.php?isAdd=true&ren=$ren&date=$Value_selectDate_Daily_Type_';
    try {
      var response = await http.get(Uri.parse(url));
