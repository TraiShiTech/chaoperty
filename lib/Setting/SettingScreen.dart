                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (_formKey2
                                                                      ...
                                                                      for (int index =
                                                                              0;
                                                                          index <
                                                                              int.parse('${Add_totalnew_area_text.text}');
                                                                          index++) {
                                                                        // var area_ser =
                                                                        //     'ADD_Auto${index + 1}';
                                                                        ...
                                                                        var Add_Number_area_New = (index ==
                                                                            ...
                                                                            : int.parse('${Add_Number_area_.text}') +
                                                                                (index);
